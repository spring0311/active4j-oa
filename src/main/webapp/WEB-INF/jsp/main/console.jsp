...
<%--<div class="row  border-bottom white-bg dashboard-header">
    <div class="col-sm-4">
        ...
        &lt;%&ndash;<small>欢迎扫描以下二维码关注我们：</small>&ndash;%&gt;
        &lt;%&ndash;<br>&ndash;%&gt;
        &lt;%&ndash;<br>&ndash;%&gt;
        &lt;%&ndash;<img src="https://zh-active4j-1251505225.cos.ap-shanghai.myqcloud.com/active4jboot/active4j-wx.jpg" width="100%" style="max-width:264px;">&ndash;%&gt;
        &lt;%&ndash;<br>&ndash;%&gt;
    </div>
    <div class="col-sm-4">
        <h3>
        ...
        &lt;%&ndash;<p>Active4j-jsp是基于SpingBoot2.0轻量级的java快速开发框架。以Spring Framework为核心容器，Spring MVC为模型视图控制器，Mybatis Plus为数据访问层， Apache Shiro为权限授权层, Redis为分布式缓存，Quartz为分布式集群调度，JSP作为前端页面引擎，采用JSTL标签库封装组件的开源框架。</p>&ndash;%&gt;
        &lt;%&ndash;<p>Active4j-jsp定位于企业快速开发平台建设，代码全部开源，持续更新，共同维护。Active4j-jsp可以应用在任何J2EE的项目开发中，尤其适合企业信息管理系统（MIS），企业办公系统（OA），客户关系管理系统（CRM）等。</p>&ndash;%&gt;
        &lt;%&ndash;<p>&ndash;%&gt;
        &lt;%&ndash;<b>当前版本：</b>active4j-jsp版&ndash;%&gt;
        &lt;%&ndash;</p>&ndash;%&gt;
        &lt;%&ndash;<p>&ndash;%&gt;
        &lt;%&ndash;<b>官方网站：</b><span class="label"><a href="www.active4j.com" target="_blank">www.active4j.com</a></span>&ndash;%&gt;
        &lt;%&ndash;</p>&ndash;%&gt;
        &lt;%&ndash;<p>&ndash;%&gt;
        &lt;%&ndash;<b>QQ群：</b><span class="label label-warning">203802692</span>&ndash;%&gt;
        &lt;%&ndash;</p>&ndash;%&gt;
        &lt;%&ndash;<br>&ndash;%&gt;
        &lt;%&ndash;<p>&ndash;%&gt;
        &lt;%&ndash;<a class="btn btn-success btn-outline" href="https://github.com/yunchaoyun/active4j-jsp" target="_blank">&ndash;%&gt;
        &lt;%&ndash;<i class="fa fa-home"> </i> github&ndash;%&gt;
        &lt;%&ndash;</a>&ndash;%&gt;
        &lt;%&ndash;<a class="btn btn-white btn-bitbucket" href="https://gitee.com/active4j/active4j-jsp" target="_blank">&ndash;%&gt;
        &lt;%&ndash;<i class="fa fa-home"></i> gitee&ndash;%&gt;
        &lt;%&ndash;</a>&ndash;%&gt;
        &lt;%&ndash;</p>&ndash;%&gt;
    </div>
    <div class="col-sm-4">
